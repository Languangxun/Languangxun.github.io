...
- 首屏「MONOLOGUE」手写动画：`_includes/monologue-ink.svg`，由 [GenLineAnimation-Server](https://github.com/jrenc2002/GenLineAnimation-Server) 的签名接口生成（全大写；其小写 o 字形数据有缺陷，会渲染成墨点），已压平为单个自包含 SVG，逐笔 stroke-dashoffset 书写
